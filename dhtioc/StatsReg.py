...
class StatsRegClass:
    ...
    def Show(self):
        ...
        print(
            "\t%s=%g\t%s=%g" % ("SumX  ", self.sumX, "SumXX", self.sumXX)
        )
        print(
            "\t%s=%g\t%s=%g" % ("SumY  ", self.sumY, "SumYY", self.sumYY)
        )
        print(
            "\t%s=%g\t%s=%g" % ("weight", self.weight, "SumXY", self.sumXY)
        )
    ...
    def LinearRegression(self):
        ...
        if self.slope == None or self.intercept == None:
            ...
            self.slope = (
                self.weight * self.sumXY - self.sumX * self.sumY
            ) / determ
            self.intercept = (
                self.sumXX * self.sumY - self.sumX * self.sumXY
            ) / determ
    ...
    def LinearRegressionCorrelation(self):
        ...
        if self.r == None:
            ...
            self.r = (
                self.weight * self.sumXX - self.sumX * self.sumY
            ) / math.sqrt(VarX * VarY)
        return self.r
    ...
    def CorrelationCoefficient(self):
        ...
        if self.correlation == None:
            self.correlation = -self.sumX / math.sqrt(
                self.weight * self.sumXX
            )
...
def __selftest():
    ...
    print(
        "\tLinearRegressionCorrelation = %g"
        % reg.LinearRegressionCorrelation()
    )
